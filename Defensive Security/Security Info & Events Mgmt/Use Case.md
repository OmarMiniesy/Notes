...
- Based on the [[Logs]] data generated and used by the SIEM, the use cases are developed to make sense of the events and correlate them to match and detect for incidents, part of the [[Incident Handling]] process.
